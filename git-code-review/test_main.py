...
if __name__ == '__main__':
    ...
    # Datos de evento simulados para pruebas
    event = {
        'body': json.dumps({
            'action': 'opened',
            'pull_request': {
    ...
    # Definir changeset simulado para pruebas
    stubbed_changeset = """
    ...
    # Crear un contexto simulado con full_context
    context = MockContext(full_context=stubbed_changeset)
    
    # Llamar a la función lambda_handler con el contexto simulado
